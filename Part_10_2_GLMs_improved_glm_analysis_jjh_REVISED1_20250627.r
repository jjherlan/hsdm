...
# Check if pROC package is available, if not provide alternative
...
# Create comparison table with proper data types
comparison_table <- data.frame(
  ...
  stringsAsFactors = FALSE  # Ensure proper handling of character data
)

# Display results (fix the rounding issue with mixed data types)
cat("\n=== Model Comparison ===\n")

# Create a properly formatted table for display
